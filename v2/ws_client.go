...
//
//// addWsParam add param with key/value to wsParams string
//func (r *request) addWsParam(key string, value interface{}) *request {
//	if r.wsParams == nil {
//		r.wsParams = params{}
//	}
//	r.wsParams[key] = value
//	return r
//}
//
//// setWsParam set param with key/value to wsParams string
//func (r *request) setWsParam(key string, value interface{}) *request {
//	if r.wsParams == nil {
//		r.wsParams = params{}
//	}
//
...
//}
//
//// setWsParams set params with key/values to wsParams string
//func (r *request) setWsParams(m params) *request {
//	for k, v := range m {
//		r.setWsParam(k, v)
//	}
//	return r
