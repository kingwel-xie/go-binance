...
// Endpoints
const (
	baseWsMainPublicUrl        = "wss://fstream.binance.com/public/ws"
	baseWsMainMarketeUrl       = "wss://fstream.binance.com/market/ws"
	baseWsMainPrivateUrl       = "wss://fstream.binance.com/private/ws"
	baseWsTestnetUrl           = "wss://stream.binancefuture.com/ws"
	baseCombinedMainPublicURL  = "wss://fstream.binance.com/public/stream?streams="
	baseCombinedMainMarketURL  = "wss://fstream.binance.com/market/stream?streams="
	baseCombinedMainPrivateURL = "wss://fstream.binance.com/private/stream?streams="
...
func getCombinedEndpoint() string {
	...
	return baseCombinedMainPublicURL
}
...
func getCombinedMarketEndpoint() string {
	...
	return baseCombinedMainMarketURL
}
...
// WsCombinedMarketTickerServe is similar to WsMarketTickerServe, but it handles multiple symbols
...
func WsCombinedBookTickerServe(symbols []string, handler WsBookTickerHandler, errHandler ErrHandler) (doneC, stopC chan struct{}, err error) {
	endpoint := baseCombinedMainPublicURL
	for _, s := range symbols {
